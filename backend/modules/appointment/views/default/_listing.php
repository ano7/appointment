...
<tr class="inner-box">
  ...
  ?>
  <td>
    <div class="primary-btn"> <a class="btn btn-primary" href="#" onclick="appointmentStatus(<?=$model->id?>,'APPROVED','<?=$Status?>')">Approve</a> </div>
  </td>
  <?php } else { ?> 
  <td>
    <div class="primary-btn"> <a class="btn btn-warning" href="#" onclick="appointmentStatus(<?=$model->id?>,'RESCHEDULED','<?=$Status?>')">Re-Schedule</a> </div>
  </td>  
  <?php } ?>
  <td>
    <div class="primary-btn"> <a class="btn btn-danger" href="#" onclick="appointmentStatus(<?=$model->id?>,'REJECTED','<?=$Status?>')">Reject</a> </div>
  </td>
